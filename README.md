...
- supports unicode messages ,but not emojis (use firefox engine for emoji support)
- some fixes were done for xpath to match whatsappweb html changes as of 14/07/2022
- pyinstaller is optional and can be used for building standalone executebles 
  ```sh
  pip install pyinstaller==5.2
  pyinstaller --onefile image_msg.py
  ```

 All the credits goes to original creator [Kalebu](https://github.com/Kalebu)
